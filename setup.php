...
$queries = [
    ...
    "CREATE TABLE IF NOT EXISTS results (id INTEGER PRIMARY KEY, timestamp DATETIME DEFAULT CURRENT_TIMESTAMP, participant_id TEXT, station_id INTEGER, user_id INTEGER, points INTEGER, time_seconds INTEGER, bottles INTEGER DEFAULT 0, type TEXT)"
];
